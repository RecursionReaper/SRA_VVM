...
def generate_launch_description():
    ...
    ####### DATA INPUT END ##########
    config = os.path.join( get_package_share_directory('simulation_vvm'),
    'config',
    'vvm.yaml'
    )
    ...
    robot_state_publisher_node = Node(
        ...
        emulate_tty=True,
        parameters=[{'use_sim_time': True, 'robot_description': ParameterValue(Command(['xacro ',xacro_path]), value_type=str)}],
        output="screen"
    )
